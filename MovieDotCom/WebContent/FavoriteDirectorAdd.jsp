...
<title>Add Favorite Director</title>
...
<body>
	...
	<div class="container hero-spacer">
		...
		<div class="row">
			<form class="form-horizontal" action="favoritedirectoradd" method="post">
				...
				<div class="form-group" <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
					...
					<div class="col-sm-10">
						<input id="fn" name="fn" placeholder="First Name">
					</div>
				</div>
				<div class="form-group" <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
					<label for="ln" class="col-sm-2 control-label">Last name</label>
					<div class="col-sm-10">
						<input id="ln" name="ln" placeholder="Last Name">
					</div>
				</div>
