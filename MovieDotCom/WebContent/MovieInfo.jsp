...
<body>
    ...
    <div class="container super-hero-spacer">
        ...
        <div class="row">
            <div class="col-md-6">
                <h2>Trailer 1</h2>
                <iframe width="420" height="315" src="https://www.youtube.com/embed/Y1wRv8vTpxo" frameborder="0" allowfullscreen></iframe>
            </div>
            <!-- /.col-md-4 -->
            <div class="col-md-6">
                <h2>Trailer 2</h2>
                <iframe width="420" height="315" src="https://www.youtube.com/embed/tjW1mKwNUSo" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <!-- /.row -->
