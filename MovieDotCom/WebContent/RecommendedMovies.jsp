	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="recommendation.view.html">Customized
						recommendation</a></li>
					...
					<c:forEach items="${movies}" var="m">
						<div class="col-md-3 col-sm-6 hero-feature">
							<div class="thumbnail" style="height: 500px; overflow: hidden;">
								<img height="500" width="800" src='<c:out value="${m.getImageURL()}" />' alt="starting">
								<div class="caption">
									<h3><c:out value="${m.getTitle()}" /></h3>
									<p>
										<font color="blue">Year</font>: <c:out value="${m.getYear()}" />
									</p>
									<p>
										<font color="blue">Rating</font>: <c:out value="${m.getRating()}" />
									</p>
									<p>
										<font color="blue">Description</font>: <c:out value="${m.getDescription()}" />
									</p>
								</div>
							</div>
						</div>
